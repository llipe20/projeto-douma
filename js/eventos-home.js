...
const rolagem = (iteracao) => {

    const left = document.getElementById(`botton-left${iteracao}`)
    const right = document.getElementById(`botton-right${iteracao}`)
    const section = document.getElementById(`section-${iteracao}`)
    const ul = document.getElementById(`ul-${iteracao}`)
    ...
    const scrollRight = () => {
        ...
        if (margin >= ( - (widthMax - width)) || ((width + margin) - widthMax) < width / 4) 
        {
            margin = widthMax - width - 80
        }
        else 
        {
            margin -= width / 4
    ...
    window.addEventListener('resize', () => {
        ...
        if (width > 800) {
            return widthMax = 20 * 220
        }
        else {
            return widthMax = 20 * 130
        }
    })
